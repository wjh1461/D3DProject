...
{
	// 명령 큐, 명령 할당자, 명령 리스트를 생성해야 함.
	// CommandQueue Descriptor 생성.
	...
	ThrowIfFailed(md3dDevice->CreateCommandList(0, D3D12_COMMAND_LIST_TYPE_DIRECT, mDirectCmdListAlloc.Get(), nullptr,
